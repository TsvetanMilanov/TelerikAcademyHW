...
CREATE TABLE IF NOT EXISTS `sakila`.`country` (
  `country_id` SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
...
CREATE TABLE IF NOT EXISTS `sakila`.`city` (
  `city_id` SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
  `city` VARCHAR(50) NOT NULL COMMENT '',
  `country_id` SMALLINT UNSIGNED NOT NULL COMMENT '',
  `last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
  PRIMARY KEY (`city_id`)  COMMENT '',
  INDEX `idx_fk_country_id` (`country_id` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `sakila`.`address` (
  `address_id` SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
  `address` VARCHAR(50) NOT NULL COMMENT '',
  `address2` VARCHAR(50) NULL DEFAULT NULL COMMENT '',
  `district` VARCHAR(20) NOT NULL COMMENT '',
  `city_id` SMALLINT UNSIGNED NOT NULL COMMENT '',
  `postal_code` VARCHAR(10) NULL DEFAULT NULL COMMENT '',
  `phone` VARCHAR(20) NOT NULL COMMENT '',
  `last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
  PRIMARY KEY (`address_id`)  COMMENT '',
  INDEX `idx_fk_city_id` (`city_id` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `sakila`.`category` (
  `category_id` TINYINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
...
CREATE TABLE IF NOT EXISTS `sakila`.`store` (
  `store_id` TINYINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
  `manager_staff_id` TINYINT UNSIGNED NOT NULL COMMENT '',
  `address_id` SMALLINT UNSIGNED NOT NULL COMMENT '',
  `last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
  PRIMARY KEY (`store_id`)  COMMENT '',
  UNIQUE INDEX `idx_unique_manager` (`manager_staff_id` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `sakila`.`staff` (
  ...
  INDEX `idx_fk_store_id` (`store_id` ASC)  COMMENT '',
  INDEX `idx_fk_address_id` (`address_id` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `sakila`.`customer` (
  `customer_id` SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
  `store_id` TINYINT UNSIGNED NOT NULL COMMENT '',
  `first_name` VARCHAR(45) NOT NULL COMMENT '',
  `last_name` VARCHAR(45) NOT NULL COMMENT '',
  `email` VARCHAR(50) NULL DEFAULT NULL COMMENT '',
  ...
  `last_update` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
  PRIMARY KEY (`customer_id`)  COMMENT '',
  INDEX `idx_fk_store_id` (`store_id` ASC)  COMMENT '',
  INDEX `idx_fk_address_id` (`address_id` ASC)  COMMENT '',
  INDEX `idx_last_name` (`last_name` ASC)  COMMENT '',
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COMMENT = 'Table storing all customers. Holds foreign keys to the addre';
...
CREATE TABLE IF NOT EXISTS `sakila`.`language` (
  `language_id` TINYINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
...
CREATE TABLE IF NOT EXISTS `sakila`.`film` (
  ...
  `special_features` SET('Trailers','Commentaries','Deleted Scenes','Behind the Scenes') NULL DEFAULT NULL COMMENT '',
  `last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
...
CREATE TABLE IF NOT EXISTS `sakila`.`film_actor` (
  `actor_id` SMALLINT UNSIGNED NOT NULL COMMENT '',
  `film_id` SMALLINT UNSIGNED NOT NULL COMMENT '',
  `last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
  PRIMARY KEY (`actor_id`, `film_id`)  COMMENT '',
  INDEX `idx_fk_film_id` (`film_id` ASC)  COMMENT '',
  INDEX `fk_film_actor_actor_idx` (`actor_id` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `sakila`.`film_category` (
  ...
  `last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
  PRIMARY KEY (`film_id`, `category_id`)  COMMENT '',
  INDEX `fk_film_category_category_idx` (`category_id` ASC)  COMMENT '',
  INDEX `fk_film_category_film_idx` (`film_id` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `sakila`.`film_text` (
  ...
  `description` TEXT NULL DEFAULT NULL COMMENT '',
  PRIMARY KEY (`film_id`)  COMMENT '',
  FULLTEXT INDEX `idx_title_description` (`title` ASC, `description` ASC)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sakila`.`inventory` (
  `inventory_id` MEDIUMINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
  `film_id` SMALLINT UNSIGNED NOT NULL COMMENT '',
  `store_id` TINYINT UNSIGNED NOT NULL COMMENT '',
  `last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
  PRIMARY KEY (`inventory_id`)  COMMENT '',
  INDEX `idx_fk_film_id` (`film_id` ASC)  COMMENT '',
  INDEX `idx_store_id_film_id` (`store_id` ASC, `film_id` ASC)  COMMENT '',
  INDEX `fk_inventory_store_idx` (`store_id` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `sakila`.`rental` (
  `rental_id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `rental_date` DATETIME NOT NULL COMMENT '',
  `inventory_id` MEDIUMINT UNSIGNED NOT NULL COMMENT '',
  `customer_id` SMALLINT UNSIGNED NOT NULL COMMENT '',
  `return_date` DATETIME NULL DEFAULT NULL COMMENT '',
  `staff_id` TINYINT UNSIGNED NOT NULL COMMENT '',
  `last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
  PRIMARY KEY (`rental_id`)  COMMENT '',
  UNIQUE INDEX `idx_rental` (`rental_date` ASC, `inventory_id` ASC, `customer_id` ASC)  COMMENT '',
  INDEX `idx_fk_inventory_id` (`inventory_id` ASC)  COMMENT '',
  INDEX `idx_fk_customer_id` (`customer_id` ASC)  COMMENT '',
  INDEX `idx_fk_staff_id` (`staff_id` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `sakila`.`payment` (
  `payment_id` SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
  `customer_id` SMALLINT UNSIGNED NOT NULL COMMENT '',
  `staff_id` TINYINT UNSIGNED NOT NULL COMMENT '',
  `rental_id` INT NULL DEFAULT NULL COMMENT '',
  ...
  INDEX `idx_fk_staff_id` (`staff_id` ASC)  COMMENT '',
  INDEX `idx_fk_customer_id` (`customer_id` ASC)  COMMENT '',
  INDEX `fk_payment_rental_idx` (`rental_id` ASC)  COMMENT '',
